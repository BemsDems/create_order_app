...
- Каждый абзац — РАЗВЁРНУТЫЙ: минимум четыре-пять полноценных предложений с конкретикой (что сделал, на чём, какой эффект). Не короткое summary, не одно предложение на абзац.
...
- ОДИН плотный абзац — минимум семь-восемь полноценных предложений с конкретикой. Не короткое summary.
- Без пустых строк внутри. Без подписи, без приветствия, без заголовков, без markdown.
